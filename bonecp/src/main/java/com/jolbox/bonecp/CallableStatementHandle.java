...
public class CallableStatementHandle extends PreparedStatementHandle implements
	...
	public void setDate(String parameterName, Date x, Calendar cal)
		...
		try {
			...
			if (this.logStatementsEnabled){
				this.logParams.put(parameterName, x+", cal="+cal);
			}
		} catch (Throwable t) {
			throw this.connectionHandle.markPossiblyBroken(t);
	...
	public void setNull(String parameterName, int sqlType) throws SQLException {
		...
		try {
			...
			if (this.logStatementsEnabled){
				this.logParams.put(parameterName, "[SQL NULL type "+sqlType+"]");
			}
		} catch (Throwable t) {
			throw this.connectionHandle.markPossiblyBroken(t);
	...
	public void setNull(String parameterName, int sqlType, String typeName)
		...
		try {
			...
			if (this.logStatementsEnabled){
				this.logParams.put(parameterName, "[SQL NULL type "+sqlType+", type="+typeName+"]");
			}
		} catch (Throwable t) {
			throw this.connectionHandle.markPossiblyBroken(t);
